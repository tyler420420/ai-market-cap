...
def generate_html_report(stocks: list, output_path: str):
    ...
    html += '<div style="background:#0d1a0d;border:1px solid #2ea043;border-radius:8px;padding:8px 14px;min-width:145px;box-shadow:0 0 10px rgba(46,160,67,0.3)"><div style="color:#2ea043;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; SOONEST IPO</div><a href="https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001956868" target="_blank" style="color:#00ff88;font-size:0.95em;font-weight:bold;text-decoration:none">Applied Aerospace</a><div style="color:#8b949e;font-size:0.68em">Defense | $634M | Jun 3</div></div>'
    html += '<div style="background:#0d1a2e;border:1px solid #1f6feb;border-radius:8px;padding:8px 14px;min-width:145px;box-shadow:0 0 10px rgba(31,111,235,0.3)"><div style="color:#1f6feb;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; NEXT SOONEST</div><a href="https://www.spacex.com/ipo" target="_blank" style="color:#58a6ff;font-size:0.95em;font-weight:bold;text-decoration:none">SpaceX</a><div style="color:#8b949e;font-size:0.68em">Aerospace | $1.5T | Jun 12</div></div>'
    html += '<div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:145px"><div style="color:#ffd700;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><a href="https://discord.com/ipo" target="_blank" style="color:#58a6ff;font-size:0.95em;font-weight:bold;text-decoration:none">Discord</a><div style="color:#8b949e;font-size:0.68em">Social | $15B | Q3 2026</div></div>'
    html += '<div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:145px"><div style="color:#ffd700;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><a href="https://www.databricks.com/company/corporate-overview/ipo" target="_blank" style="color:#58a6ff;font-size:0.95em;font-weight:bold;text-decoration:none">Databricks</a><div style="color:#8b949e;font-size:0.68em">AI Data | $134B | Q3 2026</div></div>'
    html += '<div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:145px"><div style="color:#ffd700;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><a href="https://openai.com/enterprise" target="_blank" style="color:#58a6ff;font-size:0.95em;font-weight:bold;text-decoration:none">OpenAI</a><div style="color:#8b949e;font-size:0.68em">AI | $1T | Late 2026</div></div>'
    html += '</div>'
