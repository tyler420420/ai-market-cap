...
def generate_html_report(stocks: list, output_path: str):
    ...
    for i, stock in enumerate(stocks[:20], 1):
        ...
        days_color = '#ff4444' if stock.days_to_earnings == 0 else ('#ffcc00' if stock.days_to_earnings <= 7 else ('#58a6ff' if stock.days_to_earnings <= 21 else '#00ff88'))
