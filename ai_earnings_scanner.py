...
def generate_html_report(stocks: list, output_path: str):
    ...
    html += '<div class=header><div class=hdr-row><div><a href="https://aismarketcap.com" style="color:#58a6ff;text-decoration:none"><h1>' + SCANNER_TITLE + '</h1></a><a href="https://x.com/AIMoneyMach" target="_blank" style="color:#58a6ff;text-decoration:none;vertical-align:middle;margin-left:8px"><svg height="18" width="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a><div class=desc>Pre-earnings momentum scanner for Tech sector</div></div>'
    html += '<div style="display:flex;align-items:center;justify-content:center;text-align:center;padding:0 15px;gap:12px"><div style="background:#0d1a0d;border:1px solid #2ea043;border-radius:8px;padding:8px 14px;min-width:150px;box-shadow:0 0 10px rgba(46,160,67,0.3)"><div style="color:#2ea043;font-size:0.65em;font-weight:bold;margin-bottom:2px">&#128293; SOONEST IPO</div><div style="color:#00ff88;font-size:0.95em;font-weight:bold">Monzo</div><div style="color:#8b949e;font-size:0.68em">Fintech | $8B | Q2 2026</div></div><div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:150px"><div style="color:#ffd700;font-size:0.7em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><div style="color:#58a6ff;font-size:0.95em;font-weight:bold">SpaceX</div><div style="color:#8b949e;font-size:0.68em">Aerospace | $1.5T | Late 2026</div></div><div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:150px"><div style="color:#ffd700;font-size:0.7em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><div style="color:#58a6ff;font-size:0.95em;font-weight:bold">OpenAI</div><div style="color:#8b949e;font-size:0.68em">AI | $1T | 2026-2027</div></div><div style="background:#0d1520;border:1px solid #ffd700;border-radius:8px;padding:8px 14px;min-width:150px"><div style="color:#ffd700;font-size:0.7em;font-weight:bold;margin-bottom:2px">&#128293; TOP IPO</div><div style="color:#58a6ff;font-size:0.95em;font-weight:bold">Anthropic</div><div style="color:#8b949e;font-size:0.68em">AI | $300B | Late 2026</div></div></div>'
