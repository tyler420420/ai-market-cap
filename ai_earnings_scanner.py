...
def generate_html_report(stocks: list, output_path: str):
    ...
    html += '<script>var SUB_POP_SHOWN=localStorage.getItem("sub_pop_shown");if(!SUB_POP_SHOWN){setTimeout(function(){document.getElementById("sub-popup").classList.add("show");localStorage.setItem("sub_pop_shown","1")},8000)}</script>'
