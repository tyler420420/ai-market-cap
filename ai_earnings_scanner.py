...
def generate_html_report(stocks: list, output_path: str):
    ...
    html += "@media(max-width:768px){body{padding:10px}.header{padding:15px;border-radius:8px}.hdr-row{flex-direction:column;align-items:start;gap:10px}h1{font-size:1.3em}.desc{font-size:0.82em}.btn{padding:8px 16px;font-size:0.82em}#refreshBtn,#scanBtn{margin-top:4px}.ticker-strip{font-size:0.72em}.pick-banner{flex-direction:column;gap:8px;padding:16px;text-align:center}.pick-banner span{justify-content:center}.stat{padding:8px 10px}.note,.disclaimer{padding:10px 12px;font-size:0.75em}#chat-btn{bottom:16px;right:16px;padding:10px 20px;font-size:0.88em}#chat-panel{right:10px;bottom:70px;width:calc(100vw-20px);max-width:360px}table{font-size:0.72em}th,td{padding:6px 4px!important}th{font-size:0.65em}}"
