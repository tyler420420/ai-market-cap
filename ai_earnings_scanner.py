...
def generate_html_report(stocks: list, output_path: str):
    ...
    html += '@media(max-width:600px){body{padding:5px;font-size:13px}#stockTable{font-size:12px;overflow-x:auto;display:block}#stockTable thead,#stockTable tbody,#stockTable tr,#stockTable td,#stockTable th{display:block}#stockTable thead{position:absolute;top:-9999px;left:-9999px}#stockTable tr{border:1px solid #30363d;border-radius:8px;margin-bottom:10px;padding:8px;background:#161b22}#stockTable td{position:relative;padding:3px 8px;border:none;font-size:12px;line-height:1.4}#stockTable td:before{content:attr(data-label);font-weight:700;color:#58a6ff;margin-right:6px}#stockTable td.earn-cell{font-size:11px}#stockTable td a{font-size:13px!important}.header{margin:8px;border-radius:8px;padding:12px 8px!important;background:#161b22;border:1px solid #30363d}.hdr-row{width:100%;flex-wrap:wrap;justify-content:space-between!important}.hdr-row>div:nth-child(2){max-width:100%!important;width:100%;margin:8px 0;justify-content:center}.ticker-strip{border-radius:8px;margin:0 8px 8px;background:#161b22;border:1px solid #30363d;overflow:hidden}.note,.disclaimer{border:1px solid #30363d;border-radius:8px;margin:8px;padding:10px 8px!important;background:#161b22}}'
