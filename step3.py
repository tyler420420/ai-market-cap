...
if p3 in content:
    content = content.replace(p3, "html+='<td>'+fmtMktcap(r.mktcap)+'</td>';html+='<td style=\"color:#fff\">'+r.short_int+'%</td>';html+='<td style=\"color:#fff\">'+r.iv+'%</td>';html+='<td>'+newsHtml(r.news)+'</td></tr>';")
    print('Step3: Done')
else:
