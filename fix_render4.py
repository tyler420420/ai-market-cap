...
# The file uses escaped double quotes \" inside single-quoted Python strings
# pattern: html+='<tr style=\"background:'+bg+'\"><td>...
...
if old in content:
    ...
    # try the actual pattern from debug output
    idx2 = content.find("html+='<tr style=\"background:'+bg+'")
    if idx2 >= 0:
        print('FOUND anchor at', idx2)
